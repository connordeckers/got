...
// Returns a plain value T and a Promise<T>
export type Promiseish<T> = T extends Promise<infer R>
	? R | Promise<R>
	: T | Promise<T>;
...
*/
export type HandlerFunction = <T extends GotReturn>(
	options: Options,
...
export type OptionsOfTextResponseBody = Merge<
	OptionsInit,
	{ isStream?: false; resolveBodyOnly?: false; responseType?: "text" }
>;
// eslint-disable-next-line @typescript-eslint/naming-convention
export type OptionsOfJSONResponseBody = Merge<
	OptionsInit,
	{ isStream?: false; resolveBodyOnly?: false; responseType?: "json" }
>;
export type OptionsOfBufferResponseBody = Merge<
	OptionsInit,
	{ isStream?: false; resolveBodyOnly?: false; responseType: "buffer" }
>;
export type OptionsOfUnknownResponseBody = Merge<
	OptionsInit,
	{ isStream?: false; resolveBodyOnly?: false }
>;
...
export type OptionsWithPagination<T = unknown, R = unknown> = Merge<
	OptionsInit,
...
export type GotRequestFunction = {
	...
	(
		url: string | URL,
		options?: Merge<OptionsInit, { isStream: true }>
	): Request;
...
*/
export type GotStream = GotStreamFunction &
	Record<HTTPAlias, GotStreamFunction>;
